...
PetscErrorCode OPFLOWModelSetNumVariables_IBCAR(OPFLOW opflow,PetscInt *busnvar,PetscInt *branchnvar,PetscInt *nx)
{
...
PetscErrorCode OPFLOWModelSetNumConstraints_IBCAR(OPFLOW opflow,PetscInt *branchnconeq,PetscInt *busnconeq,PetscInt *nconeq,PetscInt *nconineq)
{
  PetscInt i;
  PS       ps=opflow->ps;
  PSBUS    bus;
...
PetscErrorCode OPFLOWModelCreate_IBCAR(OPFLOW opflow)
{
  ...
  opflow->modelops.setvariableandconstraintbounds = OPFLOWSetVariableandConstraintBounds_IBCAR;
  opflow->modelops.setinitialguess = OPFLOWSetInitialGuess_IBCAR;
  opflow->modelops.computeequalityconstraints = OPFLOWComputeEqualityConstraints_IBCAR;
  opflow->modelops.computeinequalityconstraints = OPFLOWComputeInequalityConstraints_IBCAR;
  opflow->modelops.computeequalityconstraintjacobian = OPFLOWComputeEqualityConstraintJacobian_IBCAR;
  opflow->modelops.computeinequalityconstraintjacobian = OPFLOWComputeInequalityConstraintJacobian_IBCAR;
