...
/* Initialization is done on the host through this function. Copying over values to the device is done in OPFLOWSetInitialGuessArray_PBPOLRAJAHIOPSPARSE
*/
...
PetscErrorCode OPFLOWSetInitialGuess_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,Vec X)
{
  ...
  ierr = OPFLOWSetInitialGuess_PBPOL(opflow,X);CHKERRQ(ierr);
...
*/
PetscErrorCode OPFLOWSetConstraintBounds_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,Vec Gl,Vec Gu)
{
  PetscErrorCode ierr;
...
*/
PetscErrorCode OPFLOWSetVariableBounds_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,Vec Xl,Vec Xu)
{
  PetscErrorCode ierr;
...
PetscErrorCode OPFLOWModelSetUp_PBPOLRAJAHIOPSPARSE(OPFLOW opflow)
{
  ...
  /* Need to compute the number of nonzeros in equality, inequality constraint Jacobians and Hessian */
...
extern PetscErrorCode OPFLOWComputeEqualityConstraintJacobian_PBPOL(OPFLOW,Vec,Mat);
extern PetscErrorCode OPFLOWComputeInequalityConstraintJacobian_PBPOL(OPFLOW,Vec,Mat);
...
PetscErrorCode OPFLOWModelCreate_PBPOLRAJAHIOPSPARSE(OPFLOW opflow)
{
  ...
  opflow->modelops.setvariableboundsarray               = OPFLOWSetVariableBoundsArray_PBPOLRAJAHIOPSPARSE;
  opflow->modelops.setconstraintbounds                  = OPFLOWSetConstraintBounds_PBPOLRAJAHIOPSPARSE;
  opflow->modelops.setconstraintboundsarray             = OPFLOWSetConstraintBoundsArray_PBPOLRAJAHIOPSPARSE;
  ...
  opflow->modelops.computeequalityconstraintsarray      = OPFLOWComputeEqualityConstraintsArray_PBPOLRAJAHIOPSPARSE;
  opflow->modelops.computeinequalityconstraintsarray    = OPFLOWComputeInequalityConstraintsArray_PBPOLRAJAHIOPSPARSE;
  opflow->modelops.computeobjectivearray                = OPFLOWComputeObjectiveArray_PBPOLRAJAHIOPSPARSE;
  opflow->modelops.computegradientarray                 = OPFLOWComputeGradientArray_PBPOLRAJAHIOPSPARSE;
  ...
  opflow->modelops.computesparseequalityconstraintjacobianhiop            = OPFLOWComputeSparseEqualityConstraintJacobian_PBPOLRAJAHIOPSPARSE;
  ...
  opflow->modelops.computesparsehessianhiop             = OPFLOWComputeSparseHessian_PBPOLRAJAHIOPSPARSE;
  opflow->modelops.computedenseequalityconstraintjacobianhiop = OPFLOWComputeDenseEqualityConstraintJacobian_PBPOLRAJAHIOPSPARSE;
  opflow->modelops.computedenseinequalityconstraintjacobianhiop = OPFLOWComputeDenseInequalityConstraintJacobian_PBPOLRAJAHIOPSPARSE;
  opflow->modelops.computedensehessianhiop    = OPFLOWComputeDenseHessian_PBPOLRAJAHIOPSPARSE;
