...
/* Functions to create and destroy data arrays for different
   component classes
*/
int BUSParamsRajahiopsparse::destroy(OPFLOW opflow)
{
...
int BUSParamsRajahiopsparse::copy(OPFLOW opflow)
{
  /* Allocate the arrays */
...
int BUSParamsRajahiopsparse::allocate(OPFLOW opflow)
{
  PS             ps=opflow->ps;
  PetscInt       loc;
  PSBUS          bus;
...
int LINEParamsRajahiopsparse::copy(OPFLOW opflow)
{
  /* Allocate the arrays */
  auto& resmgr = umpire::ResourceManager::getInstance();
  h_allocator_ = resmgr.getAllocator("HOST");
...
int LINEParamsRajahiopsparse::destroy(OPFLOW opflow)
{
...
int LINEParamsRajahiopsparse::allocate(OPFLOW opflow)
{
  PS             ps=opflow->ps;
...
int LOADParamsRajahiopsparse::copy(OPFLOW opflow)
{
  /* Allocate the arrays */
  auto& resmgr = umpire::ResourceManager::getInstance();
  h_allocator_ = resmgr.getAllocator("HOST");
...
int LOADParamsRajahiopsparse::destroy(OPFLOW opflow)
{
...
int LOADParamsRajahiopsparse::allocate(OPFLOW opflow)
{
  PS             ps=opflow->ps;
...
int GENParamsRajahiopsparse::destroy(OPFLOW opflow)
{
...
int GENParamsRajahiopsparse::copy(OPFLOW opflow)
{
...
int GENParamsRajahiopsparse::allocate(OPFLOW opflow)
{
  PS             ps=opflow->ps;
...
PetscErrorCode OPFLOWSetInitialGuessArray_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,double* x0_dev)
{
  PetscErrorCode ierr;
  double         *x;
  auto& resmgr = umpire::ResourceManager::getInstance();
...
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
...
PetscErrorCode OPFLOWComputeEqualityConstraintsArray_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double *x_dev, double *ge_dev)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
...
PetscErrorCode OPFLOWComputeInequalityConstraintsArray_PBPOLRAJAHIOPSPARSE(OPFLOW opflow, const double *x_dev, double *gi_dev)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
  LINEParamsRajahiopsparse     *lineparams=&pbpolrajahiopsparse->lineparams;
  PetscInt               flps=0;
...
PetscErrorCode OPFLOWComputeObjectiveArray_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double *x_dev,double *obj)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
  GENParamsRajahiopsparse     *genparams=&pbpolrajahiopsparse->genparams;
  LOADParamsRajahiopsparse     *loadparams=&pbpolrajahiopsparse->loadparams;
...
/** GRADIENT **/
PetscErrorCode OPFLOWComputeGradientArray_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double *x_dev, double* grad_dev)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
  GENParamsRajahiopsparse   *genparams=&pbpolrajahiopsparse->genparams;
  LOADParamsRajahiopsparse     *loadparams=&pbpolrajahiopsparse->loadparams;
...
PetscErrorCode OPFLOWSetVariableBoundsArray_old_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,double *xl_dev,double *xu_dev)
{
  PetscErrorCode ierr;
  double         *xl,*xu;
  auto& resmgr = umpire::ResourceManager::getInstance();
...
PetscErrorCode OPFLOWSetVariableBoundsArray_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,double *xl_dev,double *xu_dev)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
  BUSParamsRajahiopsparse      *busparams=&pbpolrajahiopsparse->busparams;
  GENParamsRajahiopsparse      *genparams=&pbpolrajahiopsparse->genparams;
...
PetscErrorCode OPFLOWComputeSparseInequalityConstraintJacobian_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double* x_dev,int *iJacS_dev, int *jJacS_dev,double *MJacS_dev)
{
  PetscFunctionBegin;
  PetscFunctionReturn(0);
}

PetscErrorCode OPFLOWComputeSparseEqualityConstraintJacobian_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double* x_dev,int *iJacS_dev, int *jJacS_dev,double *MJacS_dev)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
  GENParamsRajahiopsparse     *genparams=&pbpolrajahiopsparse->genparams;
  LOADParamsRajahiopsparse     *loadparams=&pbpolrajahiopsparse->loadparams;
...
PetscErrorCode OPFLOWComputeSparseHessian_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double *x_dev,const double *lambda_dev,int *iHSS_dev, int *jHSS_dev,double *MHSS_dev)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
  PetscErrorCode ierr;
  GENParamsRajahiopsparse     *genparams=&pbpolrajahiopsparse->genparams;
 ...
 */
PetscErrorCode OPFLOWComputeDenseEqualityConstraintJacobian_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double *x_dev,double *JacD_dev)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
  BUSParamsRajahiopsparse      *busparams=&pbpolrajahiopsparse->busparams;
  LINEParamsRajahiopsparse     *lineparams=&pbpolrajahiopsparse->lineparams;
 ...
 */
PetscErrorCode OPFLOWComputeDenseInequalityConstraintJacobian_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double *x_dev,double *JacD_dev)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
  LINEParamsRajahiopsparse     *lineparams=&pbpolrajahiopsparse->lineparams;
  PetscErrorCode      ierr;
 ...
 */
PetscErrorCode OPFLOWComputeDenseEqualityConstraintHessian_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double *x_dev,const double* lambda_dev, double *HDD_dev)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
  BUSParamsRajahiopsparse   *busparams=&pbpolrajahiopsparse->busparams;
  LINEParamsRajahiopsparse  *lineparams=&pbpolrajahiopsparse->lineparams;
 ...
 * @param[inout] HDD_dev Hessian matrix with size nxdense x nxdense
 */
PetscErrorCode OPFLOWComputeDenseInequalityConstraintHessian_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double *x_dev,const double* lambda_dev, double *HDD_dev)
{
  PbpolModelRajaHiopSparse* pbpolrajahiopsparse = reinterpret_cast<PbpolModelRajaHiopSparse*>(opflow->model);
  LINEParamsRajahiopsparse  *lineparams=&pbpolrajahiopsparse->lineparams;
  int                 nxsparse=opflow->nxsparse;
...
PetscErrorCode OPFLOWComputeDenseHessian_PBPOLRAJAHIOPSPARSE(OPFLOW opflow,const double *x_dev, const double *lambda_dev,double *HDD_dev)
{
  PetscErrorCode ierr;
  int nxdense = opflow->nxdense;
  ...
  ierr = OPFLOWComputeDenseEqualityConstraintHessian_PBPOLRAJAHIOPSPARSE(opflow,x_dev,lambda_dev,HDD_dev);CHKERRQ(ierr);

  if(opflow->nconineq) {
    ierr = OPFLOWComputeDenseInequalityConstraintHessian_PBPOLRAJAHIOPSPARSE(opflow,x_dev,lambda_dev+opflow->nconeq,HDD_dev);CHKERRQ(ierr);
  }
