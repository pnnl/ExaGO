...
struct GENParamsRajahiopsparse
{
public:
  // Host data
...
struct LOADParamsRajahiopsparse
{
  // Host data
...
struct LINEParamsRajahiopsparse
{
  // Host data
  ...
  int    *geqidxf_dev_; /* Starting location of from side to insert equality constraint contribution in constraints vector */
  int    *geqidxt_dev_; /* Starting location of to side to insert equality constraint contribution in constraints vector */
  int    *gineqidx_dev_; /* Starting location to insert contribution to inequality constraint */
  int    *gbineqidx_dev_; /* Starting location to insert contribution to inequality constraint bound */
  int    *linelimidx_dev_; /* Indices for subset of lines that have finite limits */
...
struct PbpolModelRajaHiopSparse : public _p_FormPBPOLRAJAHIOPSPARSE
{
  PbpolModelRajaHiopSparse(OPFLOW opflow)
  {
  }
  ...
  ~PbpolModelRajaHiopSparse()
  {
  }

  GENParamsRajahiopsparse  genparams;
  LOADParamsRajahiopsparse loadparams;
  LINEParamsRajahiopsparse lineparams;
  BUSParamsRajahiopsparse  busparams;
};
