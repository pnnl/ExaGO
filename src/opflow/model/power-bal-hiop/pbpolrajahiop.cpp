...
/* Initialization is done on the host through this function. Copying over values to the device is done in OPFLOWSetInitialGuessArray_PBPOLRAJAHIOP
*/
...
PetscErrorCode OPFLOWSetInitialGuess_PBPOLRAJAHIOP(OPFLOW opflow,Vec X)
{
  ...
  ierr = OPFLOWSetInitialGuessArray_PBPOLHIOP(opflow,x);CHKERRQ(ierr);
...
PetscErrorCode OPFLOWModelCreate_PBPOLRAJAHIOP(OPFLOW opflow)
{
  ...
  opflow->modelops.computesparseequalityconstraintjacobianhiop            = OPFLOWComputeSparseEqualityConstraintJacobian_PBPOLRAJAHIOP;
  opflow->modelops.computesparseinequalityconstraintjacobianhiop            = OPFLOWComputeSparseInequalityConstraintJacobian_PBPOLRAJAHIOP;
