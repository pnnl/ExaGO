...
find_path(
  IPOPT_INCLUDE_DIR
  NAMES IpTNLP.hpp
  PATHS ${IPOPT_DIR} ${IPOPT_ROOT_DIR} $ENV{IPOPT_DIR} ${IPOPT_LIBRARY_DIR}/..
...
if(IPOPT_LIBRARY AND IPOPT_INCLUDE_DIR)
  ...
  # Use SYSTEM to avoid compiler warnings about Ipopt headers...
  target_include_directories(Ipopt SYSTEM INTERFACE ${IPOPT_INCLUDE_DIR})
else()
  if(NOT IPOPT_LIB)
  ...
  if(NOT IPOPT_INCLUDE_DIR)
    message(
      STATUS "Ipopt include directory  not found! Please provide correct path."
    )
  endif()
endif()
