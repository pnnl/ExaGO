# Downloaded from http://www.cmake.org/pipermail/cmake/2011-January/041666.html
# * Added FORCE to location var * Function to macro so module_FOUND shows up *
# Remove ``if(NOT PY_${module})`` so runs each time, also remove module caps *
# Module name, not path in fphsa * Added version handling via parse_version call

# .rst:
#
# Find if a Python module is installed. Usage: find_python_module(<package>
# [[ATLEAST | EXACT] version] [QUIET] [REQUIRED])
...
macro(find_python_module module)
  ...
  execute_process(
    COMMAND "${Python_EXECUTABLE}" "-c" "import re; \
             import ${module}; \
  ...
  if(NOT ${_${module}_status})
    set(PY_${module}
        ${_${module}_location}
        CACHE STRING "Location of Python module ${module}" FORCE
    )
    execute_process(
    ...
    if(NOT ${_${module}_ver_status})
      set(${module}_VERSION
          ${_${module}_version}
          CACHE STRING "Version of Python module ${module}" FORCE
      )
  ...
  find_package_handle_standard_args(
    ${module} DEFAULT_MSG PY_${module} _${module}_requested_version_found
  )
endmacro()
