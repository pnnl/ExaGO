...
# automake@1.16.3%gcc@7.3.0 arch=linux-centos7-broadwell
module load automake-1.16.3-gcc-7.3.0-ivyjt5e
...
module load camp-0.2.2-gcc-7.3.0-2agseyd
...
# hdf5@1.10.8%gcc@7.3.0~cxx~fortran~hl~ipo~java+mpi+shared~szip~threadsafe+tools api=default build_type=RelWithDebInfo arch=linux-centos7-broadwell
module load hdf5-1.10.8-gcc-7.3.0-pwake4l
...
module load hiop-0.5.3-gcc-7.3.0-7tshlqi
# hypre@2.22.0%gcc@7.3.0~complex~cuda~debug+fortran~int64~internal-superlu~mixedint+mpi~openmp+shared~superlu-dist~unified-memory arch=linux-centos7-broadwell
module load hypre-2.22.0-gcc-7.3.0-awyryrp
# hypre@2.23.0%gcc@7.3.0~complex~cuda~debug+fortran~int64~internal-superlu~mixedint+mpi~openmp+shared~superlu-dist~unified-memory arch=linux-centos7-broadwell
module load hypre-2.23.0-gcc-7.3.0-b6orqvo
...
module load magma-2.6.1-gcc-7.3.0-rba2dwe
...
module load raja-0.14.0-gcc-7.3.0-hxpsfjn
...
# superlu-dist@7.1.1%gcc@7.3.0~cuda~int64~ipo~openmp~rocm+shared build_type=RelWithDebInfo arch=linux-centos7-broadwell
module load superlu-dist-7.1.1-gcc-7.3.0-dt6bray
...
module load umpire-6.0.0-gcc-7.3.0-463bev3
