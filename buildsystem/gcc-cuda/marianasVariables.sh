...
# hiop@0.4.1%gcc@7.3.0+cuda~deepchecking~ipo~jsrun+kron+mpi+raja+shared+sparse build_type=Release cuda_arch=60 arch=linux-centos7-x86_64
module load exasgd-hiop/0.4.1/cuda-10.2.89/openmpi-3.1.3/gcc-7.3.0-irr2n7a
...
# magma@2.5.4%gcc@7.3.0+cuda+fortran~ipo+shared build_type=RelWithDebInfo cuda_arch=60 arch=linux-centos7-x86_64
module load exasgd-magma/2.5.4/cuda-10.2.89/gcc-7.3.0-hopwkmt
