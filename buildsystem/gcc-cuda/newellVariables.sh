...
module load blt-0.4.1-gcc-7.4.0-gtund23
...
module load camp-0.2.2-gcc-7.4.0-fgaacyq
# cmake@3.22.1%gcc@7.4.0~doc+ncurses+openssl+ownlibs~qt build_type=Release arch=linux-rhel7-power9le
module load cmake-3.22.1-gcc-7.4.0-pch2w6v
...
module load hdf5-1.10.8-gcc-7.4.0-nkgqj64
...
module load hiop-0.5.3-gcc-7.4.0-ucleakw
# hiop@0.5.3%gcc@7.4.0+cuda+deepchecking~ipo~jsrun~kron+mpi+raja~rocm~shared+sparse build_type=RelWithDebInfo cuda_arch=70 arch=linux-rhel7-power9le
# module load exasgd-hiop/0.5.3/cuda-10.2/openmpi-3.1.5/gcc-7.4.0-6g6qwel

# hypre@2.23.0%gcc@7.4.0~complex~cuda~debug+fortran~int64~internal-superlu~mixedint+mpi~openmp+shared~superlu-dist~unified-memory arch=linux-rhel7-power9le
module load hypre-2.23.0-gcc-7.4.0-ti2eoez
# ipopt@3.12.10%gcc@7.4.0+coinhsl+debug~metis~mumps arch=linux-rhel7-power9le
module load ipopt-3.12.10-gcc-7.4.0-ydsivcz
...
module load magma-2.6.1-gcc-7.4.0-72uszic
...
# petsc@3.16.2%gcc@7.4.0~X~batch~cgns~complex~cuda~debug+double~exodusii~fftw~giflib+hdf5~hpddm~hwloc+hypre~int64~jpeg~knl~kokkos~libpng~libyaml~memkind+metis~mkl-pardiso~mmg~moab~mpfr+mpi~mumps~openmp~p4est~parmmg~ptscotch~random123~rocm~saws~scalapack+shared~strumpack~suite-sparse+superlu-dist~tetgen~trilinos~valgrind clanguage=C arch=linux-rhel7-power9le
module load petsc-3.16.2-gcc-7.4.0-wv77z2k
...
module load raja-0.14.0-gcc-7.4.0-byib65v
...
module load superlu-dist-7.1.1-gcc-7.4.0-ebmqaii
...
module load umpire-6.0.0-gcc-7.4.0-42v4zzo
