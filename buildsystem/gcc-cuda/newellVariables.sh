...
module load exasgd-hiop/0.4.1/cuda-10.2.89-system/openmpi-3.1.5/gcc-7.4.0-26m7qsd
...
export EXTRA_CMAKE_ARGS="$EXTRA_CMAKE_ARGS -DCMAKE_CUDA_ARCHITECTURES=70 -DPETSC_DIR=$PETSC_DIR"
