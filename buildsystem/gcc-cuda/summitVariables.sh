...
module load exasgd-coinhsl/2015.06.23/gcc-10.2.0-kio55bv
...
module load exasgd-hiop/develop/cuda-11.5.2/spectrum-mpi-10.4.0.3-20210112/gcc-10.2.0-dda7m5r
# ipopt@3.12.10%gcc@10.2.0+coinhsl~debug+metis~mumps patches=712f729 arch=linux-rhel8-ppc64le
module load exasgd-ipopt/3.12.10/gcc-10.2.0-eyhong6
...
# spectrum-mpi@10.4.0.3-20210112%gcc@10.2.0 arch=linux-rhel8-ppc64le
module load exasgd-spectrum-mpi/10.4.0.3-20210112/gcc-10.2.0-co5gogo
