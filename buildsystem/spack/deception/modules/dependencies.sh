...
# exago@develop%gcc@10.2.0+cuda+hiop~ipo+ipopt+mpi+python+raja~rocm build_system=cmake build_type=RelWithDebInfo cuda_arch=60,70,75,80 dev_path=/people/svcexasgd/gitlab/19610/spack_deception arch=linux-centos7-zen2
## module load exago-develop-gcc-10.2.0-4ft5ucq
