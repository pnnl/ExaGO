...
# blt@0.5.2%gcc@10.2.0 build_system=generic arch=linux-centos7-zen2
module load blt-0.5.2-gcc-10.2.0-igrb32p
...
# camp@2022.03.2%gcc@10.2.0+cuda~ipo+openmp~rocm~tests build_system=cmake build_type=RelWithDebInfo cuda_arch=60,70,75,80 arch=linux-centos7-zen2
module load camp-2022.03.2-gcc-10.2.0-sdti4bq
...
# raja@2022.03.0%gcc@10.2.0+cuda~examples~exercises~ipo+openmp~rocm+shared~tests build_system=cmake build_type=RelWithDebInfo cuda_arch=60,70,75,80 arch=linux-centos7-zen2
module load raja-2022.03.0-gcc-10.2.0-r6762ze
...
# umpire@2022.03.1%gcc@10.2.0+c+cuda+device_alloc~deviceconst~examples~fortran~ipo~numa~openmp~rocm~shared build_system=cmake build_type=RelWithDebInfo cuda_arch=60,70,75,80 tests=none arch=linux-centos7-zen2
module load umpire-2022.03.1-gcc-10.2.0-ccipzs5
...
module load hiop-develop-gcc-10.2.0-mzujbzv
...
# exago@develop%gcc@10.2.0+cuda+hiop~ipo+ipopt+logging+mpi+python+raja~rocm build_system=cmake build_type=RelWithDebInfo cuda_arch=60,70,75,80 dev_path=/people/svcexasgd/gitlab/18977/spack_deception arch=linux-centos7-zen2
## module load exago-develop-gcc-10.2.0-rypc2n4
