...
# hip@5.4.0%clang@14.0.2~ipo build_system=cmake build_type=Release patches=ca523f1 arch=linux-sles15-zen3
module load hip-5.4.0-clang-14.0.2-pwib5ib
# hsa-rocr-dev@5.4.0%clang@14.0.2+image~ipo+shared build_system=cmake build_type=Release patches=71e6851 arch=linux-sles15-zen3
module load hsa-rocr-dev-5.4.0-clang-14.0.2-noz3nbq
# llvm-amdgpu@5.4.0%clang@14.0.2~ipo~link_llvm_dylib~llvm_dylib~openmp+rocm-device-libs build_system=cmake build_type=Release patches=a08bbe1 arch=linux-sles15-zen3
module load llvm-amdgpu-5.4.0-clang-14.0.2-3mfupqd
...
module load camp-0.2.3-clang-14.0.2-a5r5kdz
...
# hipblas@5.4.0%clang@14.0.2~ipo build_system=cmake build_type=Release arch=linux-sles15-zen3
module load hipblas-5.4.0-clang-14.0.2-wuoffuc
# hipsparse@5.4.0%clang@14.0.2~ipo build_system=cmake build_type=Release arch=linux-sles15-zen3
module load hipsparse-5.4.0-clang-14.0.2-piqjghe
...
module load magma-2.7.0-clang-14.0.2-pmcvrg2
...
# rocprim@5.4.0%clang@14.0.2~ipo amdgpu_target=auto build_system=cmake build_type=Release arch=linux-sles15-zen3
module load rocprim-5.4.0-clang-14.0.2-uyov2zt
...
module load raja-0.14.0-clang-14.0.2-rljmzgw
...
module load umpire-6.0.0-clang-14.0.2-kjcoeoj
...
module load hiop-develop-clang-14.0.2-ztyfcac
...
## module load exago-develop-clang-14.0.2-mp2a6tx
