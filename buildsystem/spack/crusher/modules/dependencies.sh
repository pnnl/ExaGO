...
module load perl-5.34.0-clang-14.0.0-rocm5.2.0-5kcimfq
...
## module load openssl-1.1.1t-clang-14.0.0-rocm5.2.0-rfhzb7b
...
module load cmake-3.20.6-clang-14.0.0-rocm5.2.0-ktwarsq
# blt@0.4.1%clang@14.0.0-rocm5.2.0 build_system=generic arch=linux-sles15-zen3
module load blt-0.4.1-clang-14.0.0-rocm5.2.0-vzot4bs
...
module load camp-0.2.3-clang-14.0.0-rocm5.2.0-m7zvzfq
...
module load openblas-0.3.20-clang-14.0.0-rocm5.2.0-bsjwfys
# coinhsl@2019.05.21%clang@14.0.0-rocm5.2.0+blas build_system=autotools arch=linux-sles15-zen3
module load coinhsl-2019.05.21-clang-14.0.0-rocm5.2.0-2bvkuoc
...
module load ginkgo-1.5.0.glu_experimental-clang-14.0.0-rocm5.2.0-njcosei
...
module load magma-2.6.2-clang-14.0.0-rocm5.2.0-4j4kykm
...
module load metis-5.1.0-clang-14.0.0-rocm5.2.0-ozsw3n7
...
module load raja-0.14.0-clang-14.0.0-rocm5.2.0-xaoyw3r
...
module load autoconf-2.69-clang-14.0.0-rocm5.2.0-4lyv2hp
# automake@1.16.5%clang@14.0.0-rocm5.2.0 build_system=autotools arch=linux-sles15-zen3
module load automake-1.16.5-clang-14.0.0-rocm5.2.0-i6wn43k
...
module load gmp-6.2.1-clang-14.0.0-rocm5.2.0-kvlb2l4
...
module load umpire-6.0.0-clang-14.0.0-rocm5.2.0-k7r3ebl
# hiop@0.7.2.mpi-fix%clang@14.0.0-rocm5.2.0~cuda+deepchecking+ginkgo~ipo~jsrun+kron+mpi+raja+rocm~shared+sparse amdgpu_target=gfx90a build_system=cmake build_type=RelWithDebInfo generator=make arch=linux-sles15-zen3
module load hiop-0.7.2.mpi-fix-clang-14.0.0-rocm5.2.0-4vqvung
