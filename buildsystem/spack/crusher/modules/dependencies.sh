...
# coinhsl@2019.05.21%cce@14.0.2-rocm5.2.0+blas build_system=autotools arch=linux-sles15-zen3
module load coinhsl-2019.05.21-cce-14.0.2-rocm5.2.0-yjak35z
...
module load suite-sparse-5.13.0-cce-14.0.2-rocm5.2.0-sztzlr4
...
module load hiop-develop-cce-14.0.2-rocm5.2.0-yzb53tl
# ipopt@3.12.10%cce@14.0.2-rocm5.2.0+coinhsl+debug~metis~mumps build_system=autotools arch=linux-sles15-zen3
module load ipopt-3.12.10-cce-14.0.2-rocm5.2.0-2uz4kah
...
module load petsc-3.18.3-cce-14.0.2-rocm5.2.0-yi5wdkv
...
## module load exago-develop-cce-14.0.2-rocm5.2.0-6jof7uv
