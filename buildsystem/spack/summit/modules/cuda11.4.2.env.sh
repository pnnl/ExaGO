module use -a /gpfs/alpine2/stf006/world-shared/nkouk/parco-cuda11.4.2-spack-install/summit-modules/linux-rhel8-power9le
...
# xz@5.2.5%gcc@10.2.0~pic libs=shared,static arch=linux-rhel8-power9le
module load xz-5.2.5-gcc-10.2.0-x3b5hud
# zlib@1.2.12%gcc@10.2.0+optimize+pic+shared patches=0d38234 arch=linux-rhel8-power9le
module load zlib-1.2.12-gcc-10.2.0-j3g46dc
# libxml2@2.10.1%gcc@10.2.0~python arch=linux-rhel8-power9le
module load libxml2-2.10.1-gcc-10.2.0-wkkknmv
# cuda@11.4.2%gcc@10.2.0~allow-unsupported-compilers~dev arch=linux-rhel8-power9le
module load cuda-11.4.2-gcc-10.2.0-rxp5tdj
# camp@0.2.3%gcc@10.2.0+cuda~ipo+openmp~rocm~tests build_type=RelWithDebInfo cuda_arch=70 arch=linux-rhel8-power9le
module load camp-0.2.3-gcc-10.2.0-ufkgnzv
...
module load raja-0.14.0-gcc-10.2.0-74waavg
...
module load umpire-6.0.0-gcc-10.2.0-k7f35xy
...
#module load hiop-0.7.2-gcc-10.2.0-wyjzs7e
...
## module load exago-parco-gcc-10.2.0-fxukj2j
