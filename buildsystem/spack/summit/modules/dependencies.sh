...
module load hiop/develop-gcc-10.2.0-6ytx35l
...
# exago@=develop%gcc@=10.2.0+cuda+hiop~ipo+ipopt+logging+mpi~python+raja~rocm build_system=cmake build_type=MinSizeRel cuda_arch=70 dev_path=/gpfs/alpine/scratch/nkouk/csc359/ExaGO-github generator=make arch=linux-rhel8-power9le
## module load exago/develop-gcc-10.2.0-xiwpghp
