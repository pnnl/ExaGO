...
# gmake@=4.4.1%gcc@=11.2.0~guile build_system=generic arch=linux-rhel8-power9le
module load gmake/4.4.1-gcc-11.2.0-be3zbwp
...
module load libiconv/1.17-gcc-11.2.0-o2tcupm
...
module load openblas/0.3.25-gcc-11.2.0-dyai6of
...
module load libxcrypt/4.4.35-gcc-11.2.0-al6z57g
