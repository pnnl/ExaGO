...
module load curl/8.1.2-gcc-8.5.0-c2sr4hi
# cmake@=3.26.3%gcc@=8.5.0~doc+ncurses+ownlibs build_system=generic build_type=Release arch=linux-centos8-power9le
module load cmake/3.26.3-gcc-8.5.0-ckhjqlf
# blt@=0.4.1%gcc@=8.5.0 build_system=generic arch=linux-centos8-power9le
module load blt/0.4.1-gcc-8.5.0-ni7pn4o
...
module load camp/0.2.3-gcc-8.5.0-bywqp3d
...
module load openblas/0.3.23-gcc-8.5.0-dkppgeo
# coinhsl@=2019.05.21%gcc@=8.5.0+blas build_system=autotools arch=linux-centos8-power9le
module load coinhsl/2019.05.21-gcc-8.5.0-v2gnrhd
...
module load ginkgo/1.5.0.glu_experimental-gcc-8.5.0-7mb7s74
...
module load magma/2.6.2-gcc-8.5.0-immm4zn
...
module load metis/5.1.0-gcc-8.5.0-q627thb
...
module load raja/0.14.0-gcc-8.5.0-nwcazlv
...
module load autoconf/2.69-gcc-8.5.0-gk7wfwg
# automake@=1.16.5%gcc@=8.5.0 build_system=autotools arch=linux-centos8-power9le
module load automake/1.16.5-gcc-8.5.0-6oid3q6
...
module load gmp/6.2.1-gcc-8.5.0-tqt7l6s
...
module load libxml2/2.10.3-gcc-8.5.0-ldtrnfs
# pigz@=2.7%gcc@=8.5.0 build_system=makefile arch=linux-centos8-power9le
module load pigz/2.7-gcc-8.5.0-qc7jldi
...
module load umpire/6.0.0-gcc-8.5.0-zifuvcz
...
module load bison/3.8.2-gcc-8.5.0-rl4rdvo
...
module load krb5/1.20.1-gcc-8.5.0-jxcsrdm
...
module load libxcrypt/4.4.35-gcc-8.5.0-q3fk75r
# openssh@=9.3p1%gcc@=8.5.0+gssapi build_system=autotools arch=linux-centos8-power9le
module load openssh/9.3p1-gcc-8.5.0-6fvit5a
...
module load git/2.41.0-gcc-8.5.0-wpvlyo5
...
module load py-pluggy/1.0.0-gcc-8.5.0-2wawfng
...
module load py-hatchling/1.17.0-gcc-8.5.0-xykrxep
# py-hatch-vcs@=0.3.0%gcc@=8.5.0 build_system=python_pip arch=linux-centos8-power9le
module load py-hatch-vcs/0.3.0-gcc-8.5.0-2dtsf4k
# py-iniconfig@=2.0.0%gcc@=8.5.0 build_system=python_pip arch=linux-centos8-power9le
module load py-iniconfig/2.0.0-gcc-8.5.0-2k565f5
# py-pytest@=7.3.2%gcc@=8.5.0 build_system=python_pip arch=linux-centos8-power9le
module load py-pytest/7.3.2-gcc-8.5.0-fzsddhx
# exago@=develop%gcc@=8.5.0+cuda+hiop~ipo+ipopt+logging+mpi+python+raja~rocm build_system=cmake build_type=MinSizeRel cuda_arch=70 dev_path=/people/svcexasgd/gitlab/22332/spack_newell generator=make arch=linux-centos8-power9le
## module load exago/develop-gcc-8.5.0-bybdibf
