...
# camp@0.2.2%gcc@8.5.0+cuda~ipo+openmp~rocm~tests build_type=RelWithDebInfo cuda_arch=70 arch=linux-centos8-power9le
...
module load raja-0.14.0-gcc-8.5.0-xutfofn
