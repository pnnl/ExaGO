See [objective_function_g_test_design.md](./tests/unit/opflow/gradient/objective_function_g_test_design.md) for a description of how this unit test is formulated.
