...
static const ExaGOSelfcheckSOPFLOWAnswer ExaGOSelfcheckSOPFLOWAnswers[ExaGOSelfcheckSOPFLOWNumAnswers] =
{
  ...
  {SOPFLOWSOLVER_IPOPT, SELFCHECK_NETWORK_CASE9_WIND, SELFCHECK_SCENARIO_CASE9, SOPFLOW_INITIALIZATION, SOPFLOW_GENBUSVOLTAGE, -1,  PETSC_TRUE, -1, SELFCHECK_CONTINGENCY_CASE9, PETSC_FALSE, "", "", 0.0, 0.0, 15, 1.2196984710420136e+04},
  {SOPFLOWSOLVER_IPOPT, SELFCHECK_NETWORK_CASE9_WIND, SELFCHECK_SCENARIO_CASE9, SOPFLOW_INITIALIZATION, SOPFLOW_GENBUSVOLTAGE, -1,  PETSC_TRUE, -1, SELFCHECK_CONTINGENCY_CASE9, PETSC_TRUE, SELFCHECK_PLOAD, SELFCHECK_QLOAD, 5.0, 0.16666667, 35,  4.4167081067087827e+05}
};
