...
{
  {SELFCHECK_NETWORK_CASE9_WIND, TCOPFLOW_INITIALIZATION, TCOPFLOW_GENBUSVOLTAGE, SELFCHECK_SCENARIO_CASE9, SELFCHECK_QLOAD, SELFCHECK_PLOAD, PETSC_FALSE, 5.0, 0.5, PETSC_FALSE, 12, 2.0792822464162207e+04}
};
