...
static const ExaGOSelfcheckOPFLOWAnswer ExaGOSelfcheckOPFLOWAnswers[ExaGOSelfcheckOPFLOWNumAnswers] =
{
  ...
  // - HIOP solver
  // -- HIOP model
  {OPFLOWSOLVER_HIOP,OPFLOWMODEL_PBPOLHIOP,SELFCHECK_NETWORK_CASE9  ,14 ,4.144460534990e+03},
  {OPFLOWSOLVER_HIOP,OPFLOWMODEL_PBPOLHIOP,SELFCHECK_NETWORK_CASE118,22,1.296606940659e+05},
  {OPFLOWSOLVER_HIOP,OPFLOWMODEL_PBPOLHIOP,SELFCHECK_NETWORK_CASE200,476,2.755757097185e+04},
  // -- RAJAHIOP model
  {OPFLOWSOLVER_HIOP,OPFLOWMODEL_PBPOLRAJAHIOP,SELFCHECK_NETWORK_CASE9  ,9 ,4.144460534985e+03},
  {OPFLOWSOLVER_HIOP,OPFLOWMODEL_PBPOLRAJAHIOP,SELFCHECK_NETWORK_CASE118,30,1.296606940659e+05},
