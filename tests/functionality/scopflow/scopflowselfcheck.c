...
static const ExaGOSelfcheckSCOPFLOWAnswer ExaGOSelfcheckSCOPFLOWAnswers[ExaGOSelfcheckSCOPFLOWNumAnswers] = 
{
  ...
  {SCOPFLOWSOLVER_IPOPT,  SELFCHECK_NETWORK_CASE200, "", SCOPFLOW_INITIALIZATION, SCOPFLOW_GENBUSVOLTAGE, 15, SELFCHECK_CONTINGENCY_CASE200, 0,PETSC_FALSE, "", "", 0.0, 0.0, 65, 2.7557571696930871e+04},

  {SCOPFLOWSOLVER_IPOPT,  SELFCHECK_NETWORK_CASE200, "", SCOPFLOW_INITIALIZATION, SCOPFLOW_GENBUSVOLTAGE, 15, SELFCHECK_CONTINGENCY_CASE200, 1,PETSC_FALSE, "", "", 0.0, 0.0, 77, 2.7557570527594460e+04},

  {SCOPFLOWSOLVER_IPOPT,  SELFCHECK_NETWORK_CASE9_WIND, "", SCOPFLOW_INITIALIZATION, SCOPFLOW_GENBUSVOLTAGE, 9, SELFCHECK_CONTINGENCY_CASE9, 0,PETSC_FALSE, "", "", 0.0, 0.0, 16, 3.0492461566531965e+03},
 
  {SCOPFLOWSOLVER_IPOPT,  SELFCHECK_NETWORK_CASE9_WIND, SELFCHECK_SCENARIO_CASE9, SCOPFLOW_INITIALIZATION, SCOPFLOW_GENBUSVOLTAGE, 9, SELFCHECK_CONTINGENCY_CASE9, 1,PETSC_TRUE, SELFCHECK_PLOAD, SELFCHECK_QLOAD, 5.0, 0.16666667, 57, 1.0256987577449478e+05},

  {SCOPFLOWSOLVER_IPOPT,  SELFCHECK_NETWORK_CASE200, SELFCHECK_SCENARIO_CASE200, SCOPFLOW_INITIALIZATION, SCOPFLOW_GENBUSVOLTAGE, 10, SELFCHECK_CONTINGENCY_CASE200, 0,PETSC_TRUE, SELFCHECK_PLOAD, SELFCHECK_QLOAD, 5.0, 0.16666667, 201, 8.6231192297308554e+05}
};
