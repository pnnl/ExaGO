...
static const ExaGOSelfcheckSCOPFLOWAnswer ExaGOSelfcheckSCOPFLOWAnswers[ExaGOSelfcheckSCOPFLOWNumAnswers] = 
{
  ...
  {SCOPFLOWSOLVER_IPOPT,  SELFCHECK_NETWORK_CASE9_WIND, "", SCOPFLOW_INITIALIZATION, SCOPFLOW_GENBUSVOLTAGE, 9, SELFCHECK_CONTINGENCY_CASE9, 0,PETSC_FALSE, "", "", 0.0, 0.0, 15, 3.0492461566531965e+03},
