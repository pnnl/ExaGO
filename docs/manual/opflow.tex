...
\small
  \begin{tabular}{|p{0.25\textwidth}|p{0.1\textwidth}|p{0.2\textwidth}|p{0,45\textwidth}|}
   \hline
    ...
    \hline
    Generator real power deviation & $\Deltapj$ & $-p^{\text{r}}_j \le \Deltapj \le p^{\text{r}}_j$ & \begin{itemize} \item Only used when \option{\opflowgensetpoint} or \option{\opflowuseagc} option is active \item $\Deltapj$ is the deviation from real power generation setpoint $\psetj$.\end{itemize} \\
    \hline
