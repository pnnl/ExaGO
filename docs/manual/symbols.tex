...
\notationtable{
  ...
  $j \in J^{\text{sh}}$ (MVar at 1 pu) \\
  $b^{\text{ch}}_j$ & charging susceptance for branch $j \in J^{\text{br}}$ (MVar at 1 pu) \\
  $b^{\text{s}}_j$ & series susceptance for branch $j \in J^{\text{br}}$ (MVar at 1 pu) \\
  ...
  %(MW at 1 pu) \\
  $\pgjset$ & real power set point of generator $j \in J^{\text{gen}}$ (MW) \\
  $\pmaxj$ & maximum real power output for generator $j \in J^{\text{gen}}$ (MW) \\
  $\pminj$ & minimum real power output for generator $j \in J^{\text{gen}}$ (MW) \\
