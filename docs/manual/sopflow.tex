...
\begin{itemize}
    ...
    \item \textbf{Contingency file:} Contingencies can be specified
      via a PTI or PSS/E format file as described in chapter \ref{chap:scopflow}. The option \lstinline{-sopflow_enable_multicontingency} should be set for multi-contingency problems.
