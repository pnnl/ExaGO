...
![ExaGO Spack Graph](images/exago_graph.png)
...
## Linting @ExaSGD Devops workflows
  ...
  2 Transition to precommit for linting influnces various capabilities and ease of working. 

  3 Pre-commit testing detects the  presence of bugs on configuration and the other project source files. 

  4 It can be applied to the linting formats (clang format, python format, file naming conventions, cmake format). 
...
2 Due to the limitations and difference in different programming languages the language interoperability becomes challenging in certain times. 

3 C, Python and Java Script are the programming languages considered for the language interoperability in ExaSGD project. 

4 Python wrapper can interact with modules consists of C, Java Script and Python scripts in the working directory. 
