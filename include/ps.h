...
*/
PETSC_EXTERN PetscErrorCode PSSetGenPowerLimits(PS,PetscInt, const char*,PetscScalar,PetscScalar,PetscScalar,PetscScalar);
...
*/
PETSC_EXTERN PetscErrorCode PSGetGenPowerLimits(PS,PetscInt, const char*,PetscScalar*,PetscScalar*,PetscScalar*,PetscScalar*);
...
. status - Generator status                                                                                                
  ...
  Notes: PSSetUp() must be called before calling PSSetGenStatus()                                
*/                  
PETSC_EXTERN PetscErrorCode PSGetGenStatus(PS,PetscInt,const char*,PetscInt*);
...
*/
PETSC_EXTERN PetscErrorCode PSGetGenDispatch(PS,PetscInt, const char*,PetscScalar*,PetscScalar*);
