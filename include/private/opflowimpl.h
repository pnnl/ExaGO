...
extern PetscErrorCode OPFLOWSetNumVariables(OPFLOW,PetscInt*,PetscInt*,PetscInt*);

/* Internal function to set number of constraints */
extern PetscErrorCode OPFLOWSetNumConstraints(OPFLOW,PetscInt*,PetscInt*,PetscInt*,PetscInt*);
