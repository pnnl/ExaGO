...
PETSC_EXTERN PetscErrorCode TCOPFLOWModelRegister(
    TCOPFLOW, const char[], PetscErrorCode (*create)(TCOPFLOW));
...
PETSC_EXTERN PetscErrorCode TCOPFLOWSetTimeStepandDuration(TCOPFLOW, PetscReal,
                                                           PetscReal);
PETSC_EXTERN PetscErrorCode TCOPFLOWSetLoadProfiles(TCOPFLOW, const char[],
                                                    const char[]);
...
PETSC_EXTERN PetscErrorCode TCOPFLOWSaveSolution(TCOPFLOW, PetscInt,
                                                 OutputFormat, const char[]);
PETSC_EXTERN PetscErrorCode TCOPFLOWSaveSolutionAll(TCOPFLOW, OutputFormat,
                                                    const char[]);
