...
PFLOWPROTO: $(OBJECTS_PFLOW) libpflow chkopts
	 -$(CLINKER) -o PFLOWPROTO $(OBJECTS_PFLOW) ${PETSC_SNES_LIB} -L${SCOPFLOW_DIR} -lpflow -Wl,-rpath=${SCOPFLOW_DIR}
	$(RM) $(OBJECTS_PFLOW)
...
#******************************
OPFLOW_SRC_OBJECTS = src/opflow/opflow.o \
                     src/opflow/econstraints.o \
                     src/opflow/iconstraints.o \
                     src/opflow/objectivefunct.o \
                     ${PS_SRC_OBJECTS}
...
SCOPFLOW_IPOPT: $(OBJECTS_SCOPFLOW2) libscopflowipopt chkopts
	 -$(CLINKER) -o SCOPFLOW_IPOPT $(OBJECTS_SCOPFLOW2) -L${SCOPFLOW_DIR} -lscopflowipopt ${PETSC_LIB} -Wl,-rpath=${SCOPFLOW_DIR}
...
SCOPFLOW_PIPS: $(OBJECTS_SCOPFLOW3) libscopflowpips chkopts
	 -$(CLINKER) -o SCOPFLOW_PIPS $(OBJECTS_SCOPFLOW3) -L${SCOPFLOW_DIR} -lscopflowpips ${PETSC_LIB} -Wl,-rpath=${SCOPFLOW_DIR}
...
SCOPFLOW_IPOPT_SRC_OBJECTS = src/scopflow/scopflow-ipopt.o \
                             src/scopflow/scopflow-ipopt-constraints.o \
                             src/scopflow/scopflow-ipopt-objective.o \
                             src/scopflow/scopflow-ipopt-hessian.o \
                             src/scopflow/scopflow-ipopt-pipsfunctions.o \
                             ${OPFLOW_IPOPT_SRC_OBJECTS}
...
SCOPFLOW_PIPS_SRC_OBJECTS = src/scopflow/scopflow-pips.o \
                            src/scopflow/scopflow-pips-constraints.o \
                            src/scopflow/scopflow-pips-hessian.o \
                            src/scopflow/scopflow-pips-objective.o \
                            ${OPFLOW_SRC_OBJECTS}
...
#******************************
cleanobj:
	rm -rf $(OBJECTS_PFLOW) $(OBJECTS_PFLOWPROTO) $(OBJECTS_PFLOW2) $(PFLOW_SRC_OBJECTS) $(OBJECTS_OPFLOW) $(OBJECTS_OPFLOW2)$(OPFLOW_SRC_OBJECTS) $(OBJECTS_SCOPFLOW2) $(SCOPFLOW_IPOPT_SRC_OBJECTS) $(SCOPFLOW_PIPS_SRC_OBJECTS) *.so *.dylib *.dSYM PFLOW PFLOWPROTO PFLOW2 OPFLOW OPFLOW_IPOPT SCOPFLOW_IPOPT SCOPFLOW_PIPS
