...
cleanobj:
	rm -rf $(OBJECTS_PFLOW) $(OBJECTS_PFLOW2) $(PFLOW_SRC_OBJECTS) $(OBJECTS_OPFLOW) $(OPFLOW_SRC_OBJECTS) $(OBJECTS_DYN) $(DYN_SRC_OBJECTS) $(OBJECTS_DYNSENS) *.dylib *.dSYM PFLOW PFLOW2 DYN OPFLOW
