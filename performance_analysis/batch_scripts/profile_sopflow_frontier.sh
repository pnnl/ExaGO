...
#SBATCH -J exasgd_sopflow_profiling
#SBATCH -o profile_sopflow_frontier_batch.%J
#SBATCH -e profile_sopflow_frontier_batch.%J
...
python3 performance_analysis/perf_pipeline.py performance_analysis/sopflow_testsuite_frontier.toml
