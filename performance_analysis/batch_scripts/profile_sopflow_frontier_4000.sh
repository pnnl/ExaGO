...
#SBATCH -J exasgd_sopflow_profiling_4000
#SBATCH -o profile_sopflow_frontier_batch_4000.%J
#SBATCH -e profile_sopflow_frontier_batch_4000.%J
...
python3 performance_analysis/perf_pipeline.py performance_analysis/sopflow_testsuite_frontier_4000.toml
