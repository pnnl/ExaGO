...
#SBATCH -J exasgd_sopflow_profiling_16_sm
#SBATCH -o profile_sopflow_frontier_batch_16_sm.%J
#SBATCH -e profile_sopflow_frontier_batch_16_sm.%J
...
python3 performance_analysis/perf_pipeline.py performance_analysis/sopflow_testsuite_frontier_16_sm.toml
