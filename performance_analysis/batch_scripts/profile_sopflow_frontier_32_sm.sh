...
#SBATCH -J exasgd_sopflow_profiling_32_sm
#SBATCH -o profile_sopflow_frontier_batch_32_sm.%J
#SBATCH -e profile_sopflow_frontier_batch_32_sm.%J
...
python3 performance_analysis/perf_pipeline.py performance_analysis/sopflow_testsuite_frontier_32_sm.toml
