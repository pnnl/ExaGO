...
#SBATCH -J exasgd_sopflow_profiling_8
#SBATCH -o profile_sopflow_frontier_batch_8.%J
#SBATCH -e profile_sopflow_frontier_batch_8.%J
...
python3 performance_analysis/perf_pipeline.py performance_analysis/sopflow_testsuite_frontier_8.toml
